    ...
    protected function buildClass(): string
    {
        return view('brackets/admin-generator::' . $this->view, [
            ...
            'columnsToQuery' => $this->readColumnsFromTable($this->tableName)->filter(function ($column) {
                ...
                } elseif ($this->readColumnsFromTable($this->tableName)->contains('name', 'updated_by_admin_user_id')) {
                ...
                } elseif ($this->readColumnsFromTable($this->tableName)->contains('name', 'created_by_admin_user_id') && $this->readColumnsFromTable($this->tableName)->contains('name', 'updated_by_admin_user_id')) {
